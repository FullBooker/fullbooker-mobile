...
import 'package:fullbooker/application/redux/actions/update_selected_product_booking_action.dart';
  ...
  Widget build(BuildContext context) {
    ...
    return InkWell(
      ...
      onTap: readOnly
          ...
          : () {
              context.dispatch(
                UpdateSelectedProductBookingAction(selectedBooking: booking),
              );
              context.router.push(ProductBookingDetailsRoute());
            },
