...
class UploadProductPhotosAction extends ReduxAction<AppState> {
  ...
  Future<AppState?> reduce() async {
    ...
    final List<ProductMedia?> existingPhotos = List<ProductMedia?>.from(
      isEdit
          ? hostState?.selectedProduct?.photos ?? <ProductMedia>[]
          : hostState?.currentProduct?.photos ?? <ProductMedia>[],
    );
