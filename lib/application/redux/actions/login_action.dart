...
import 'package:fullbooker/application/core/services/custom_api_client.dart';
...
class LoginAction extends ReduxAction<AppState> {
  ...
  final ICustomClient graphQlClient;
  ...
  Future<AppState?> reduce() async {
    ...
    final Response httpResponse = await graphQlClient.callRESTAPI(
